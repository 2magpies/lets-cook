...
function SiteInfo() {
  return (
    <div>
      ...
      <p>
        {' '}
        Welcome! So, you're in the mood whip up a fancy new dish. You've come to
        the right place. We have access to hundreds of recipes from cooks like
      ...
      <p>
        ...
        new. And by the time you cook you your way through them, we'll have
        more! Our crowd-sourced cookbook just keeps growing so you can keep
        cooking new dishes everyday.
      </p>
      <p>
